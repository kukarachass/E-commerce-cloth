            ...
            <div className="flex flex-row gap-8 py-10">
                <div className="flex flex-col gap-6 flex-1">
                    ...
                    <div className="flex flex-col gap-6 bg-[#f9f9f9] rounded-[10px] p-8">
                        ...
                        <span className="text-[var(--text)] font-medium text-[20px] leading-[120%]">Your order number is {order.id}</span>
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-row gap-4 items-center">
                                ...
                                <div className="text-[var(--text)] text-[16px] leading-[150%]">
                                    We’ll send you a confirmation mail at <span className="font-bold">{order.email}</span>
                                </div>
                            </div>
                            <div className="flex flex-row gap-4 items-center">
