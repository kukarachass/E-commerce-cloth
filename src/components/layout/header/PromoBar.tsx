...
export default function PromoBar(){
    ...
    return(
        <div className="max-w-[1200px] mx-auto w-full bg-black p-3 text-white relative">
            {showPromo ? (
    ...
    <span className="flex-1 text-center text-[clamp(13px,2vw,16px)]">
        Use code WELCOME on your first order for free shipping on orders above £35
                    ...
                    <button onClick={() => setShowPromo(false)} className="hover:bg-gray-200 rounded-[4px] shrink-0 pl-2">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.3422 4.36879L11.4263 3.45288L7.79513 7.08405L4.16396 3.45288L3.24805 4.36879L6.87922 7.99996L3.24805 11.6311L4.16396 12.547L7.79513 8.91588L11.4263 12.547L12.3422 11.6311L8.71104 7.99996L12.3422 4.36879" fill="white" />
                        </svg>
                    </button>
                </div>
            ): (
                            ...
                            {promoBlocks.map((block) => (
                                <div key={block.text} className="flex flex-row items-center gap-2">
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0.875 6.19237L5.20538 10.5L13.125 2.625" stroke="white" strokeWidth="1.75" />
                                    </svg>
