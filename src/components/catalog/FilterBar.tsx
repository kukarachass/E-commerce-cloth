            ...
            <div ref={ref} className="flex flex-row gap-2">
                {filters.map((filter) => (
                    <div
                        ...
                        key={filter.id}
                        className="relative select-none flex flex-row items-center gap-3 text-[var(--text)] text-[14px] font-bold border cursor-pointer border-[#ddd] rounded-[4px] px-2 py-[2px] bg-white">
