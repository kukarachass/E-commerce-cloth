...
export default function FavouritesPage() {
    ...
    return (
        <Container className="flex flex-col min-h-[80vh] pb-10 px-4 xl:px-0">
            {!isEmpty ? (
                <div className="flex flex-col gap-5 sm:gap-6">
                    <div className="flex flex-col gap-3 sm:gap-4 items-center pt-6 sm:pt-10">
                        <h1 className="text-[var(--text)] font-bold text-[24px] sm:text-[32px]">Favourites</h1>
                ...
                <div className="flex flex-col gap-4 py-16 sm:py-[148px] items-center max-w-[350px] mx-auto text-center">
                    <h1 className="text-[var(--text)] text-[24px] sm:text-[32px] font-bold">Favourites</h1>
                    <p className="text-[var(--text)] text-[15px] sm:text-[16px] text-center">
                    ...
                    <ButtonPrimary onClick={() => router.push(`/${gender}/brands`)} className="w-full max-w-[200px] text-[16px]" variant={"primary"}>
                        Back to all brands
                    </ButtonPrimary>
                </div>
            )}
